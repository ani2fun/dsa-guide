...
> **Output :** true  
> **Explanation :**  
> Number of digits : 3. `1^3 + 5^3 + 3^3 = 1 + 125 + 27 = 153.` Therefore, it is an Armstrong number.
...
> **Output :** false  
> **Explanation :**  
> Number of digits : 2. `1^2 + 2^2 = 1 + 4 = 5.` Therefore, it is not an Armstrong number.
